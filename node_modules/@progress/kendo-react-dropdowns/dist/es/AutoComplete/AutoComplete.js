...
import { itemIndexStartsWith, getItemValue, areSame, getItemIndexByText, getFocusedItem } from '../common/utils';
...
var AutoComplete = /** @class */ (function (_super) {
    ...
    function AutoComplete() {
        ...
        _this.onChangeHandler = function (event) {
            ...
            var focusedItem = getFocusedItem(data, value, textField);
    ...
    AutoComplete.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        if ((opened && focusedItemChanged) || opening) {
            var focusedIndex = focusedItem !== undefined ?
                data.findIndex(function (i) { return areSame(i, focusedItem, textField); }) :
                data.indexOf(getFocusedItem(data, this.value, textField));
    ...
    AutoComplete.prototype.render = function () {
        ...
        return label
            ? (React.createElement(FloatingLabel, { label: label, value: value, valid: isValid, style: { width: style ? style.width : undefined }, id: this._inputId, children: autoComplete }))
            : autoComplete;
    };
    /**
     * @hidden
    ...
    AutoComplete.prototype.applyInputValue = function (value, state, eventKey) {
        ...
        var focusedItem = this.state.focusedItem !== undefined ?
            this.state.focusedItem : getFocusedItem(data, value, textField);
        this._suggested = '';
        if (opened && eventKey === Keys.enter) {
            var newValue = getItemValue(focusedItem, textField);
    ...
    AutoComplete.prototype.renderList = function () {
        ...
        var focusedIndex = this.state.focusedItem !== undefined ?
            data.findIndex(function (i) { return areSame(i, _this.state.focusedItem, textField); }) :
            data.indexOf(getFocusedItem(data, this.value, textField));
        return (React.createElement(List, { id: base.listBoxId, show: opened, data: data.slice(), focusedIndex: focusedIndex, value: value, textField: textField, valueField: textField, highlightSelected: false, optionPrefix: base.optionPrefix, listRef: function (list) { return base.list = list; }, wrapperStyle: { maxHeight: popupSettings.height }, wrapperCssClass: "k-list-scroller", onClick: this.handleItemClick, itemRender: itemRender, noDataRender: listNoDataRender }));
    };
     ...
     * @hidden
     */
    AutoComplete.propTypes = __assign({}, DropDownBase.basicPropTypes, { suggest: PropTypes.oneOfType([PropTypes.bool, PropTypes.string]), placeholder: PropTypes.string, value: PropTypes.string, defaultValue: PropTypes.string, validationMessage: PropTypes.string, required: PropTypes.bool, readonly: PropTypes.bool });
    /**
     * @hidden
     */
