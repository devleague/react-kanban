...
var DropDownList = /** @class */ (function (_super) {
    ...
    function DropDownList() {
        ...
        _this.renderDropDownWrapper = function () {
            ...
            return (React.createElement("span", { ref: function (el) { return _this.base.wrapper = el; }, role: 'listbox', tabIndex: disabled ? undefined : tabIndex, className: classNames('k-dropdown-wrap', _this.props.className, {
        ...
        _this.renderList = function () {
            ...
            return (React.createElement(List, { id: _this.base.listBoxId, show: opened, data: data.slice(), focusedIndex: _this.focusedIndex(), value: _this.value, textField: textField, valueField: dataItemKey, optionPrefix: _this.base.optionPrefix, listRef: function (list) { return vs.list = _this.base.list = list; }, wrapperStyle: !vs.enabled ?
    ...
    DropDownList.prototype.render = function () {
        ...
        return label
            ? (React.createElement(FloatingLabel, { label: label, value: text, style: { width: style ? style.width : undefined }, valid: isValid, children: dropdownlist }))
            : dropdownlist;
    };
    /**
     * @hidden
    ...
    DropDownList.prototype.focusedIndex = function () {
        ...
        if (!hasSelected && filterText && virtual.skip === 0) {
            return data.indexOf(getFocusedItem(data, filterText, this.props.textField));
        }
        else {
     ...
     * @hidden
     */
    DropDownList.propTypes = __assign({ delay: PropTypes.number, ignoreCase: PropTypes.bool, iconClassName: PropTypes.string, defaultItem: PropTypes.any, valueRender: PropTypes.func, valueMap: PropTypes.func, validationMessage: PropTypes.string, required: PropTypes.bool }, DropDownBase.propTypes);
    /**
     * @hidden
     */
