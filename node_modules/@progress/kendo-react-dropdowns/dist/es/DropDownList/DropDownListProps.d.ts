...
export interface DropDownListProps extends FormComponentProps {
     ...
     * ([see example]({% slug binding_dropdownlist %})).
     */
    data?: any[];
    /**
     ...
     * ([see example]({% slug defaultitem_dropdownlist %})).
     ...
     * ([more information and examples]({% slug filtering_dropdownlist %})).
     */
    filterable?: boolean;
    /**
     ...
     * If `dataItemKey` is not set, the DropDownList compares the items by reference.
     * ([see example]({% slug binding_dropdownlist %}#toc-datasets-of-objects)).
     */
    dataItemKey?: string;
    /**
     * Represents a callback function, which returns the value for submitting.
     * The returned value will be rendered in an `option` of a hidden
     * [`select`](https://reactjs.org/docs/forms.html#the-select-tag) element.
     *
     * @example
     * ```jsx
     ...
     * ([see example]({% slug virtualization_dropdownlist %})).
     */
     ...
     * ([see examples]({% slug binding_dropdownlist %})).
     */
     ...
     * ([see example]({% slug customrendering_dropdownlist %}#toc-items)).
     ...
     * ([see example]({% slug customrendering_dropdownlist %}#toc-values)).
     ...
     * ([see example]({% slug customrendering_dropdownlist %}#toc-no-data)).
     * Used to override the default appearance of the element.
     */
    listNoDataRender?: (element: React.ReactElement<HTMLDivElement>) => React.ReactNode;
    /**
     * Sets the header component of the DropDownList
     * ([see example]({% slug customrendering_dropdownlist %}#toc-headers-and-footers)).
     */
