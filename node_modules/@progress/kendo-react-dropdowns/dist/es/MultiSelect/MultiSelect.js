...
var MultiSelect = /** @class */ (function (_super) {
    ...
    function MultiSelect() {
        ...
        _this.onChangeHandler = function (event) {
            ...
            if (allowCustom) {
                ...
                var focusedIndex = (value ? itemIndexStartsWith(data, value, textField) : 0) + skip;
        ...
        _this.renderList = function () {
            ...
            return (React.createElement(List, { id: _this.base.listBoxId, show: opened, data: data.slice(), focusedIndex: focusedIndex - skip, value: _this.value, textField: textField, valueField: dataItemKey, optionPrefix: _this.base.optionPrefix, listRef: function (list) { return vs.list = _this.base.list = list; }, wrapperStyle: vs.enabled ?
    ...
    MultiSelect.prototype.render = function () {
        ...
        if (tags.length === 0) {
            this.value.forEach(function (item) {
                tags.push({ text: getItemValue(item, textField), data: [item] });
            });
        }
        ...
        var component = (React.createElement("span", { ref: function (dropdown) { return _this._element = dropdown; }, className: classNames('k-widget k-multiselect k-header', className, {
            ...
            React.createElement("div", { onClick: this.handleWrapperClick, ref: function (wrapper) { return _this.base.wrapper = wrapper; }, className: "k-multiselect-wrap k-floatwrap", onMouseDown: preventDefaultNonInputs },
                React.createElement(TagList, { tagRender: this.props.tagRender, onTagDelete: this.onTagDelete, data: tags, guid: this.base.optionPrefix, focused: focusedTag ? tags.find(function (t) { return matchTags(t, focusedTag, dataItemKey); }) : undefined }),
                this.renderSearchbar(),
                this.props.loading && React.createElement("span", { className: "k-icon k-i-loading" })),
            this.renderListContainer()));
        return label
            ? (React.createElement(FloatingLabel, { label: label, value: text || getItemValue(this.value[0], textField), style: { width: style ? style.width : undefined }, children: component, valid: isValid }))
            : component;
    };
    MultiSelect.prototype.renderSearchbar = function () {
        ...
        var ariaActivedescendant = this.base.optionPrefix + '-' +
            ...
            getItemValue(focusedItem, textField) : focusedIndex;
        return (React.createElement(SearchBar, { id: this._inputId, size: Math.max((placeholderToShow || '').length, text.length, 1), tabIndex: this.props.tabIndex, placeholder: placeholderToShow, value: text, onChange: this.onChangeHandler, onKeyDown: this.onInputKeyDown, ref: this.searchbarRef, disabled: disabled, expanded: opened, owns: this.base.listBoxId, activedescendant: ariaActivedescendant, clearButton: clearButton, clearButtonClick: this.clearButtonClick }));
    };
    ...
    MultiSelect.prototype.getFocusedState = function () {
        ...
        if (selected.length) {
            ...
            var focusedInd = data.findIndex(function (i) { return areSame(i, last_1, dataItemKey); });
     ...
     * @hidden
     */
    MultiSelect.propTypes = __assign({}, DropDownBase.propTypes, { value: PropTypes.arrayOf(PropTypes.any), defaultValue: PropTypes.arrayOf(PropTypes.any), dataItemKey: PropTypes.string, placeholder: PropTypes.string, tags: PropTypes.arrayOf(PropTypes.shape({
     ...
     * @hidden
     */
    MultiSelect.defaultProps = __assign({}, DropDownBase.defaultProps, { required: false });
    return MultiSelect;
}(React.Component));
