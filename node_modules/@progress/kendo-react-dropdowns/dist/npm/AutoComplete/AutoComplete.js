...
var AutoComplete = /** @class */ (function (_super) {
    ...
    function AutoComplete() {
        ...
        _this.onChangeHandler = function (event) {
            ...
            var focusedItem = utils_1.getFocusedItem(data, value, textField);
    ...
    AutoComplete.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        if ((opened && focusedItemChanged) || opening) {
            var focusedIndex = focusedItem !== undefined ?
                data.findIndex(function (i) { return utils_1.areSame(i, focusedItem, textField); }) :
                data.indexOf(utils_1.getFocusedItem(data, this.value, textField));
    ...
    AutoComplete.prototype.render = function () {
        ...
        return label
            ? (React.createElement(kendo_react_common_1.FloatingLabel, { label: label, value: value, valid: isValid, style: { width: style ? style.width : undefined }, id: this._inputId, children: autoComplete }))
            : autoComplete;
    };
    /**
     * @hidden
    ...
    AutoComplete.prototype.applyInputValue = function (value, state, eventKey) {
        ...
        var focusedItem = this.state.focusedItem !== undefined ?
            this.state.focusedItem : utils_1.getFocusedItem(data, value, textField);
        this._suggested = '';
        if (opened && eventKey === kendo_react_common_1.Keys.enter) {
            var newValue = utils_1.getItemValue(focusedItem, textField);
    ...
    AutoComplete.prototype.renderList = function () {
        ...
        var focusedIndex = this.state.focusedItem !== undefined ?
            data.findIndex(function (i) { return utils_1.areSame(i, _this.state.focusedItem, textField); }) :
            data.indexOf(utils_1.getFocusedItem(data, this.value, textField));
        return (React.createElement(List_1.default, { id: base.listBoxId, show: opened, data: data.slice(), focusedIndex: focusedIndex, value: value, textField: textField, valueField: textField, highlightSelected: false, optionPrefix: base.optionPrefix, listRef: function (list) { return base.list = list; }, wrapperStyle: { maxHeight: popupSettings.height }, wrapperCssClass: "k-list-scroller", onClick: this.handleItemClick, itemRender: itemRender, noDataRender: listNoDataRender }));
    };
     ...
     * @hidden
     */
    AutoComplete.propTypes = __assign({}, DropDownBase_1.default.basicPropTypes, { suggest: PropTypes.oneOfType([PropTypes.bool, PropTypes.string]), placeholder: PropTypes.string, value: PropTypes.string, defaultValue: PropTypes.string, validationMessage: PropTypes.string, required: PropTypes.bool, readonly: PropTypes.bool });
    /**
     * @hidden
     */
