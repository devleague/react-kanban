...
export interface AutoCompleteProps extends FormComponentProps {
     ...
     * ([more information and example]({% slug binding_autocomplete %})).
     */
    data?: any[];
    /**
    ...
    value?: string;
    /**
     * Sets the default value of the AutoComplete.
     * Similar to the native `input` HTML element.
     */
    defaultValue?: string;
    /**
     ...
     * ([see example]({% slug suggestions_autocomplete %})).
     */
    ...
    dir?: string;
    /**
     * Sets the loading state of the AutoComplete
     * ([see example]({% slug filtering_autocomplete %}#toc-basic-configuration)).
     */
    loading?: boolean;
    /**
     ...
     * ([see example]({% slug binding_autocomplete %}#toc-datasets-of-objects)).
     ...
     * ([see example]({% slug customrendering_autocomplete %}#toc-items)).
     ...
     * ([see example]({% slug customrendering_autocomplete %}#toc-no-data)).
    ...
    /**
     * Sets the header component of the AutoComplete
     * ([see example]({% slug customrendering_autocomplete %}#toc-headers-and-footers)).
     */
    header?: React.ReactNode;
    /**
     * Sets the footer component of the AutoComplete
     * ([see example]({% slug customrendering_autocomplete %}#toc-headers-and-footers)).
     */
