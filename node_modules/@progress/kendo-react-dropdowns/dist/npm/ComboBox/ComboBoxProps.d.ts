...
export interface ComboBoxProps extends FormComponentProps {
     ...
     * ([more information and examples]({% slug binding_combobox %})).
     */
    data?: any[];
    /**
     ...
     * Clicking this button resets the value of the ComboBox to `undefined` and triggers the `change` event.
     */
    clearButton?: boolean;
    /**
     ...
     * ([see example]({% slug suggestions_combobox %})).
     */
    suggest?: boolean;
    /**
     * Specifies whether the ComboBox allows user-defined values that are not present in the dataset
     * ([see example]({% slug custom_values_combobox %})). Defaults to `false`.
     */
    allowCustom?: boolean;
    /**
     ...
     * ([more information and examples]({% slug filtering_combobox %})).
     */
    filterable?: boolean;
    /**
     * Sets the value of ComboBox input.
     * Useful for making the ComboBox input a
     * [controlled component](https://reactjs.org/docs/forms.html#controlled-components).
     */
    filter?: string | null;
    /**
     * Sets the loading state of the ComboBox
     * ([see example]({% slug filtering_combobox %}#toc-basic-configuration)).
     */
    loading?: boolean;
    /**
    ...
    textField?: string;
    /**
     * Sets the key for comparing the data items of the ComboBox.
     * If `dataItemKey` is not set, the ComboBox compares the items by reference.
     * ([see example]({% slug binding_combobox %}#toc-datasets-of-objects)).
     */
    dataItemKey?: string;
    /**
     ...
     * ([more information and examples]({% slug virtualization_combobox %})).
     */
     ...
     * ([see examples]({% slug binding_combobox %})).
     */
    onChange?: (event: ComboBoxChangeEvent) => void;
    /**
     * Fires each time the user types in the filter input
     * ([see examples]({% slug filtering_combobox %}#toc-basic-configuration)).
     ...
     * ([see example]({% slug customrendering_combobox %}#toc-items)).
     ...
     * ([see example]({% slug customrendering_combobox %}#toc-headers-and-footers)).
     */
