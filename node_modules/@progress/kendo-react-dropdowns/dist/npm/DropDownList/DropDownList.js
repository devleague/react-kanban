...
var DropDownList = /** @class */ (function (_super) {
    ...
    function DropDownList() {
        ...
        _this.renderDropDownWrapper = function () {
            ...
            return (React.createElement("span", { ref: function (el) { return _this.base.wrapper = el; }, role: 'listbox', tabIndex: disabled ? undefined : tabIndex, className: kendo_react_common_1.classNames('k-dropdown-wrap', _this.props.className, {
        ...
        _this.dummySelect = function (value) {
            ...
            return (React.createElement("select", { name: _this.props.name, ref: function (el) { _this._select = el; }, tabIndex: -1, style: { opacity: 0, width: 1, border: 0, zIndex: -1, position: 'absolute', left: '50%' } },
        ...
        _this.renderList = function () {
            ...
            return (React.createElement(List_1.default, { id: _this.base.listBoxId, show: opened, data: data.slice(), focusedIndex: _this.focusedIndex(), value: _this.value, textField: textField, valueField: dataItemKey, optionPrefix: _this.base.optionPrefix, listRef: function (list) { return vs.list = _this.base.list = list; }, wrapperStyle: !vs.enabled ?
        ...
        _this.handleKeyDown = function (event) {
            ...
            var leftOrRightKeys = keyCode === kendo_react_common_1.Keys.left || keyCode === kendo_react_common_1.Keys.right;
    ...
    DropDownList.prototype.render = function () {
        ...
        return label
            ? (React.createElement(kendo_react_common_1.FloatingLabel, { label: label, value: text, style: { width: style ? style.width : undefined }, valid: isValid, children: dropdownlist }))
            : dropdownlist;
    };
    /**
     * @hidden
    ...
    DropDownList.prototype.focusedIndex = function () {
        ...
        if (!hasSelected && filterText && virtual.skip === 0) {
            return data.indexOf(utils_1.getFocusedItem(data, filterText, this.props.textField));
        }
        else {
     ...
     * @hidden
     */
    DropDownList.propTypes = __assign({ delay: PropTypes.number, ignoreCase: PropTypes.bool, iconClassName: PropTypes.string, defaultItem: PropTypes.any, valueRender: PropTypes.func, valueMap: PropTypes.func, validationMessage: PropTypes.string, required: PropTypes.bool }, DropDownBase_1.default.propTypes);
    /**
     * @hidden
     */
