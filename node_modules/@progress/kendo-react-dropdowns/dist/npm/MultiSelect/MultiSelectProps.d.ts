...
export interface MultiSelectProps extends FormComponentProps {
     ...
     * ([see example]({% slug custom_values_multiselect %})). Defaults to `false`.
     */
    allowCustom?: boolean;
    /**
    ...
    placeholder?: string;
    /**
     * Sets the tags of the MultiSelect
     * ([see example]({% slug customtags_multiselect %})).
     */
    tags?: Array<TagData>;
    /**
     * Sets the key for comparing the data items of the MultiSelect
     * ([see example]({% slug binding_multiselect %}#toc-datasets-of-objects)).
     * If `dataItemKey` is not set, the MultiSelect compares the items by reference.
     */
    dataItemKey?: string;
    /**
     * Sets the default value of the MultiSelect.
     ...
     * ([more information and examples]({% slug filtering_multiselect %})).
     */
    filterable?: boolean;
    /**
    ...
    filter?: string;
    /**
     * Sets the loading state of the MultiSelect
     * ([see example]({% slug filtering_multiselect %}#toc-basic-configuration)).
     */
    loading?: boolean;
    /**
    ...
    /**
     * Configures the virtual scrolling of the MultiSelect
     * ([see example]({% slug virtualization_multiselect %})).
     */
    ...
    /**
     * Fires each time the value of the MultiSelect is about to change
     * ([see examples]({% slug binding_multiselect %})).
     */
    ...
    /**
     * Fires when both the virtual scrolling of the MultiSelect is enabled
     * and when the component requires data for another page
     * ([see example]({% slug virtualization_multiselect %})).
     */
    onPageChange?: (event: MultiSelectPageChangeEvent) => void;
    /**
     * Fires when a MultiSelect item is about to be rendered
     * ([see example]({% slug customrendering_multiselect %}#toc-items)).
     ...
     * ([see example]({% slug customrendering_multiselect %}#toc-no-data)).
     * Used to override the default appearance of the element.
     */
    listNoDataRender?: (element: React.ReactElement<HTMLDivElement>) => React.ReactNode;
    /**
     * Fires when a tag element is about to be rendered
     * ([see example]({% slug customrendering_multiselect %}#toc-tags)).
     * Used to override the default appearance of the element.
     */
    tagRender?: (tagData: TagData, li: React.ReactElement<HTMLLIElement>) => React.ReactElement<HTMLLIElement> | null;
    /**
     * Sets the header component of the MultiSelect
     * ([see example]({% slug customrendering_multiselect %}#toc-headers-and-footers)).
     */
    header?: React.ReactNode;
    /**
     * Sets the footer component of the MultiSelect
     * ([see example]({% slug customrendering_multiselect %}#toc-headers-and-footers)).
     */
