...
var TagList = /** @class */ (function (_super) {
    ...
    TagList.prototype.render = function () {
        var _this = this;
        return (React.createElement("ul", { className: "k-reset", role: "listbox" }, this.props.data.map(function (tagData) {
            var tag = (React.createElement("li", { className: tagData === _this.props.focused ? focusedTagClassName : tagClassName, key: tagData.text, id: _this.props.guid + '-' + tagData.text, onMouseDown: preventDefault, onClick: stopPropagation },
