...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.renderItems = function () {
        ...
        return this.props.data.map(function (item, index) {
            ...
            return (React.createElement(ListItem_1.default, { id: optionPrefix + '-' + realIndex, dataItem: item, selected: selected, focused: focusedIndex === index, index: realIndex, key: realIndex, onClick: _this.props.onClick, textField: textField, renderer: itemRender }));
        });
    };
