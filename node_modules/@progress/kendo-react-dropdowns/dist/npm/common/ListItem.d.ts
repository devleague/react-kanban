...
export interface ListItemProps {
    ...
    selected: boolean;
    /**
     * Fires when the list item is about to be rendered.
     * Used to override the default appearance of the list item.
     */
    renderer?: (li: React.ReactElement<HTMLLIElement>, itemProps: ListItemProps) => React.ReactNode;
    /**
