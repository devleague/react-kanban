...
export interface PopupSettings {
    ...
    animate?: boolean;
    /**
     * Specifies the element which will be used as an anchor
     * ([see example]({% slug alignmentpositioning_popup %})).
     * The Popup opens next to that element.
     */
    anchor?: HTMLElement;
    /**
     ...
     * ([see example]({% slug alignmentpositioning_popup %})).
     * The Popup opens next to that point. The pivot point of the Popup is defined
     * by the `popupAlign` configuration option. The boundary detection is applied
     * by using the window viewport.
     */
    offset?: Offset;
    /**
